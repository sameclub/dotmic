...
#define TUD_AUDIO10_MICROPHONE_DESC_LEN(_nfreqs) (\
    + 8 /* Interface Association Descriptor */\
...
#define TUD_AUDIO10_MICROPHONE_DESCRIPTOR(_itfnum, _stridx, _epin, _nMaxSampleRate, _nChannels_MIC, _nBytesPerSample, _nBitsUsedPerSample, ...) \
    /* UAC1 IAD: function subclass is UNDEFINED (0), not the AC interface subclass. */\
    8, TUSB_DESC_INTERFACE_ASSOCIATION, _itfnum, 2, TUSB_CLASS_AUDIO, 0, 0, _stridx,\
